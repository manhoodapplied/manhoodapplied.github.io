...
Draft entries are filtered from both collections and every generated route. The build currently requires exactly 19 published articles and 20 published social records: eleven carousels and nine Reels.
